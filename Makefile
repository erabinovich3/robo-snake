...
OFILES = main.o title_screen.o main_screen2.o game_over.o robot.o robot_logic.o font.o big_font.o drawing.o myLib.o item.o battery.o bolt.o gear.o oil.o wrench.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = title_screen.h main_screen2.h game_over.h robot.h robot_logic.h drawing.h myLib.h item.h battery.h bolt.h gear.h oil.h wrench.h
